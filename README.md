...
ダイエットの代表的な方法の一つとして、自身の体型の変化を写真で記録するというものがあります。<br>
私自身も過去にこの方法でダイエットをしましたが、この方法に最適化されたダイエットアプリが少なくアプリ選びに苦労しました。そこで、私と同じような状況になっている方の一つの選択肢になればという想いからこのアプリを開発しました。
