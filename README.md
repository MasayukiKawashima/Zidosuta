...
開発作業において、実務に近い作業フローを意識して進めました。

具体的には、以下のような流れで機能開発などを行いました。
...
1. タスクをissueとして登録する。
2. 該当するタスクのfeatureブランチをdevelopブランチから作成し、開発を行う。
3. 作業が完了したら、ローカルでコミットしてリモートにpushする。
4. プルリクエストを作成する。※
5. 作業内容を再確認して問題がなければdevelopブランチへマージをする。
6. リモートの内容をローカルにpullして、不要になったブランチを削除する。

※レビューをしてもらう方がいないため、プルリクエストは自身の作業を整理・記録する目的で使用しています。
<br>
<br>
